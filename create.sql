...
create table property_type (property_type_id bigint not null, property_type_description varchar(255), property_type_name varchar(255) not null, primary key (property_type_id)) type=InnoDB
create table rent_type (rent_type_id bigint not null, rent_type_description varchar(255), rent_type_name varchar(255) not null, primary key (rent_type_id)) type=InnoDB
create table role (role_id bigint not null, role_description varchar(255), role_name varchar(255) not null, primary key (role_id)) type=InnoDB
...
alter table property_type add constraint UK_mvffc5d6jt1xc3mnkmmqipklm unique (property_type_description)
alter table property_type add constraint UK_9fq3x4c0cg3y3icuyntpglgim unique (property_type_name)
alter table rent_type add constraint UK_m5qwr85rj5boagdx4wlyni5jt unique (rent_type_name)
alter table role add constraint UK_iubw515ff0ugtm28p8g3myt0h unique (role_name)
alter table agent add constraint FK62bop6ygdgye7vrdbyudlcjr foreign key (role_id) references role (role_id)
